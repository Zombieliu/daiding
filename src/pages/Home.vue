  ...
  <div class='bg-white'>
    ...
    <div class='relative bg-gray-900'>
                ...
                <div class='h-16 flex items-center justify-between'>
                  ...
                  <div class='hidden lg:flex-1 lg:flex lg:items-center'>
                    <a href='#'>
                      ...
                      <img class='h-8 w-auto' src='https://web3games-public.oss-ap-northeast-1.aliyuncs.com/logo-set/web3game-logo-horizontal-white.svg' alt='' />
                    </a>
                  </div>
                  ...
                  <a href='#' class='lg:hidden'>
                    <span class='sr-only'>Workflow</span>
                    <img src='https://web3games-public.oss-ap-northeast-1.aliyuncs.com/logo-set/web3game-logo-horizontal-white.svg' alt=''
                         class='h-8 w-auto' />
                  </a>
                    ...
                    <div class='flex items-center lg:ml-8'>
                      ...
                      <div class='ml-4 flow-root lg:ml-8'>
                        <a href='#' class='group -m-2 p-2 flex items-center'>
                          <ShoppingBagIcon class='flex-shink-0 h-6 w-6 text-white' aria-hidden='true' />
      ...
      <div class='relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0'>
        <h1 class='text-4xl font-extrabold tracking-tight text-white lg:text-6xl'>王冠淇️黑椒牛柳</h1>
    ...
    <main>
          ...
          <div class='relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16'>
            <div class='relative max-w-3xl mx-auto flex flex-col items-center text-center'>
              ...
              <p class='mt-3 text-xl text-white'>Make your desk beautiful and organized. Post a picture to social media
                and watch it get more likes than life-changing announcements. Reflect on the shallow nature of
                existence. At least you have a really nice desk setup.</p>
              <a href='#'
      ...
      <section aria-labelledby='comfort-heading' class='max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8'>
        <div class='relative rounded-lg overflow-hidden'>
          ...
          <div class='relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16'>
            <div class='relative max-w-3xl mx-auto flex flex-col items-center text-center'>
              <h2 id='comfort-heading' class='text-3xl font-extrabold tracking-tight text-white sm:text-4xl'>Simple
                productivity</h2>
              <p class='mt-3 text-xl text-white'>Endless tasks, limited hours, a single piece of paper. Not really a
                haiku, but we're doing our best here. No kanban boards, burndown charts, or tangled flowcharts with our
                Focus system. Just the undeniable urge to fill empty circles.</p>
              <a href='#'
                 class='mt-8 w-full block bg-white border border-transparent rounded-md py-3 px-8 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto'>Shop
                Focus</a>
            </div>
